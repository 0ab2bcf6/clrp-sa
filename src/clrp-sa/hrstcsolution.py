#!/usr/bin/env python3
"""
This module defines the HRSTCSolution class, which represents a solution for the Capacitated Location Routing Problem (CLRP) solved using heuristic methods. This includes a set of dummy zeros for more explicit search space exploration.

Classes:
    HRSTCSolution: A class to model a solution for the CLRP.
"""
